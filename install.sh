...
cp -R -o zshrc $CONFIG
cp -R -o alias $CONFIG
cp -R -o bash_profile $CONFIG
cp -R -o exports $CONFIG
cp -R -o fzf.zsh $CONFIG
cp -R -o fzf.bash $CONFIG
cp -R -o gitconfig $CONFIG
cp -R -o ovloop.sh $CONFIG
cp -R -o antigen.zsh $CONFIG
cp -r nvim $CONFIG
cp -R -o functions $CONFIG
